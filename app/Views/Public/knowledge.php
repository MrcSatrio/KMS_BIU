...
<div class="container mt-3">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-4 text-md-right">
            <button class="btn btn-warning rounded-pill mt-2 share-button" id="like-button"><i class="fas fa-thumbs-up"></i> 0.0</button>
            <button class="btn btn-primary rounded-pill mt-2 share-button" id="share-button"><i class="fas fa-share"></i> Bagikan</button>
        </div>
    </div>
