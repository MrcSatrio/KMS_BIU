        ...
        <tbody>
            <?php foreach ($kategori as $kg): ?>
                <tr>
                    ...
                    <td>
                    <a href="<?= base_url('admin/kategori/update/'.$kg['id_kategori']) ?>" class="btn btn-success btn-sm update-link">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="<?= base_url('admin/kategori/delete/'.$kg['id_kategori']) ?>" class="btn btn-danger btn-sm delete-link">
